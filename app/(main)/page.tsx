...
export default function Home() {
  return (
    <>
      ...
      {/* Perfect For Section - Full Width */}
      <section className="bg-muted/30 py-20 border-y border-border/50" style={{ width: '100vw', marginLeft: '50%', transform: 'translateX(-50%)' }}>
      ...
      <section className="relative bg-primary text-primary-foreground py-24 overflow-hidden" style={{ width: '100vw', marginLeft: '50%', transform: 'translateX(-50%)' }}>
