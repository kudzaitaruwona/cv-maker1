 ...
 * Perfect for: Corporate roles, traditional industries, entry-level positions
 * 
 * Features:
...
const ResumeTemplate1: React.FC<ResumeTemplateProps> = ({ data }) => {
          ...
          <View style={styles.section}>
            ...
            {sortedExperience.map((exp) => (
              <View key={exp.id} style={styles.item}>
                ...
                {exp.organization && (
                  <Text style={styles.itemOrganization}>{exp.organization}</Text>
                )}
                {exp.location && (
            ...
            {sortedProjects.map((project) => (
              <View key={project.id} style={styles.item}>
                ...
                {project.organization && (
                  <Text style={styles.itemOrganization}>{project.organization}</Text>
                )}
                {project.link && (
          ...
          <View style={styles.section}>
            ...
            {sortedEducation.map((edu) => (
              <View key={edu.id} style={styles.item}>
                ...
                {edu.organization && (
                  <Text style={styles.itemOrganization}>{edu.organization}</Text>
                )}
                {edu.location && (
          ...
          <View style={styles.section}>
            ...
            {sortedCertifications.map((cert) => (
              <View key={cert.id} style={styles.item}>
                ...
                {cert.organization && (
                  <Text style={styles.itemOrganization}>{cert.organization}</Text>
                )}
                {cert.link && (
                  <Link src={cert.link}>
