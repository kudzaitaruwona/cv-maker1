/**
 * Template 7: Skills-First
 * 
 * Description: Skills section near top (after summary, before experience).
 * Perfect for: Technical roles, developers, engineers
 * 
 * Features:
 * - Skills prominently displayed early
 * - Optimized for technical roles
 * - Emphasizes technical competencies
 */
...
const ResumeTemplate7: React.FC<ResumeTemplateProps> = ({ data }) => {
